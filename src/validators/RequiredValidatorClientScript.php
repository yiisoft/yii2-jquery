...
/**
 * jQuery client-side script for {@see RequiredValidator}.
 *
 ...
 * @since 1.0
 */
class RequiredValidatorClientScript extends BaseObject implements ClientValidatorScriptInterface
{
    /**
     * @return array{message: string, requiredValue?: mixed, strict?: int}
     */
